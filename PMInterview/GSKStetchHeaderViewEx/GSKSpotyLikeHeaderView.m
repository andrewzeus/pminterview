...
@property (nonatomic) FeedItem *item;

@end

@implementation GSKSpotyLikeHeaderView

- (instancetype)initWithFrame:(CGRect)frame item:(FeedItem *)item{
...
- (void)setupViews {
    ...
    if (self.item && self.item.image && self.item.image.length)
        [self.backgroundImageView sd_setImageWithURL:[NSURL URLWithString: self.item.image] placeholderImage:[UIImage imageNamed:@"placeholder"]];
    else
        [self.backgroundImageView setImage:[UIImage imageNamed:@"placeholder"]];
    ...
    if (self.item && self.item.image && self.item.image.length)
        [self.blurredBackgroundImageView sd_setImageWithURL:[NSURL URLWithString: self.item.image] placeholderImage:[UIImage imageNamed:@"placeholder"]];
    else
        [self.blurredBackgroundImageView setImage:[UIImage imageNamed:@"placeholder"]];
